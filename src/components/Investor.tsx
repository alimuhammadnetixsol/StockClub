...
const Investor: React.FC = () => {
  return (
    ...
    <div className="flex flex-col lg:flex-row px-[1rem] gap-5 items-center justify-center w-full min-h-[740px] bg-[#9F73C2] bg-[url('/images/IconPurple.png')] bg-cover bg-center">
      <div className="w-full min-h-[600px] lg:min-h-[500px] bg-white rounded-3xl p-4 lg:p-16 gap-16 flex lg:flex-row">
        ...
        <div className="lg:w-[50%] w-full flex items-center justify-center min-h-[300px] lg:min-h-[480px] md:justify-start">
          <div className="font-[500] text-[20px] lg:text-[33px] text-wrap text-[#127398] leading-[30px] lg:leading-[40px] text-center lg:text-left">
            <span className="font-[700]">Receive personalized investor reports </span>
            Receive personalized investor reports and understand how your trading activities contribute to your overall wealth.
          </div>
        </div>
